...
?>
        ...
        <div class="paiement-form-section">
          ...
          <form id="payment-form" class="payment-form">
            ...
            <div class="form-actions">
              <a href="panier.php" class="btn ghost">Retour au panier</a>
  ...
  <script>
    ...
    function renderOrderSummary() {
      ...
      document.getElementById('summary-total').innerHTML = '<strong>€' + totals.total.toFixed(2) + '</strong>';
    }
    ...
    function returnToHome() {
      window.location.href = 'site_vitrine_accueil.php';
    }
