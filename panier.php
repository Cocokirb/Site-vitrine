    ...
    <section aria-labelledby="panier-title">
      ...
      <div id="cart-content" style="display: none;">
        ...
        <div class="cart-actions">
          ...
          <button class="btn" id="checkout-btn">Procéder au paiement</button>
        </div>
      </div>
        ...
        row.innerHTML = `
          ...
          <td>
            <div class="qty-control">
              <button class="qty-btn" onclick="updateQty('${productId}', ${quantity - 1})">−</button>
              <input type="number" value="${quantity}" min="1" onchange="updateQty('${productId}', this.value)">
              <button class="qty-btn" onclick="updateQty('${productId}', ${quantity + 1})">+</button>
            </div>
          </td>
          <td>€${subtotal.toFixed(2)}</td>
          <td><button class="btn-remove" onclick="removeFromCart('${productId}')">Supprimer</button></td>
        `;
